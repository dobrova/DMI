...
>>> vars()
{'__builtins__': <module '__builtin__' (built-in)>, '__doc__': None, '__name__': '__main__', '__package__': None, 'sin': <built-in function sin>}
>>> from cmath import sinuss

Traceback (most recent call last):
  File "<pyshell#15>", line 1, in <module>
    from cmath import sinuss
ImportError: cannot import name sinuss
>>> from cmath import sin as sinuss
>>> vars()
...
>>> matematika.atan._doc_

Traceback (most recent call last):
  File "<pyshell#25>", line 1, in <module>
    matematika.atan._doc_
AttributeError: 'builtin_function_or_method' object has no attribute '_doc_'
>>> print matematika.atan._doc_
